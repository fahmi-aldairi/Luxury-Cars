          ...
          <div className="col-md-12">
                  ...
                  <div className="d-flex justify-content-start align-items-center mt-5">
                    ...
                    <header className="text-left">
                      ...
                      <h5 class="text-right animate__animated animate__fadeInRight">
                        ...
                        top-quality products and services to our clients. Our
                        team consists of highly skilled professionals who are
                        committed to delivering exceptional results that exceed
                        our clients' expectations. We strive to build
                        long-lasting relationships with our clients based on
            ...
            <div class="container mt-5 mb-5">
              <div class="row">
                <div class="col-lg-6">
                  <div
                    class="card p-5 border-0 animate__animated animate__fadeInLeft"
                ...
                <div class="col-lg-6">
                  <div
                    class="card p-5 border-0 animate__animated animate__fadeInRight"
                    style={{ boxShadow: "0px 0px 10px 0px rgba(0,0,0,0.2)" }}
                  >
                    <h3 class="section-subheading text-muted mb-4">
                      Our Mission
